...
int print_instructionCounter(void)
{
    bc_box(4, 65, 3, 22);
    mt_gotoXY(5, 73);
...
int analysis_k(enum keys k)
{
    ...
    if (k == 0 && flag_F5 != -1 && flag_F6 != -1 && !flag_RUN && !flag_T) {
        ...
        error(sc_memoryLoad(str));
            ...
            k == 1 && flag_F5 != -1 && flag_F6 != -1 && !flag_RUN && !flag_T) {
        char str[200];
        mt_gotoXY(24, 0);
        printf("%s", empty);
        mt_gotoXY(24, 0);
        ...
        error(timer());
            ...
            k == 3 && flag_F5 != -1 && flag_F6 != -1 && !flag_RUN && !flag_T) {
        ...
        if (!CU()) {
            ...
            k == 4 && flag_F5 != -1 && flag_F6 != -1 && !flag_RUN && !flag_T) {
        error(source());
        mt_gotoXY(24, 0);
        printf("%s", empty);
        flag_RUN = 0;
        ...
        flag_F6 *= (-1);
            ...
            k == 7 && flag_F5 != -1 && flag_F6 != -1 && !flag_RUN && !flag_T) {
        if (position > 9) {
            position -= 10;
        }
        instruction_counter = position;
    } else if (
            k == 8 && flag_F5 != -1 && flag_F6 != -1 && !flag_RUN && !flag_T) {
        if (position < 90) {
            position += 10;
        }
        instruction_counter = position;
    } else if (
            k == 9 && flag_F5 != -1 && flag_F6 != -1 && !flag_RUN && !flag_T) {
        if (position % 10 != 0) {
            position -= 1;
        }
        instruction_counter = position;
    } else if (
            k == 10 && flag_F5 != -1 && flag_F6 != -1 && !flag_RUN && !flag_T) {
        if (position % 10 != 9) {
            position += 1;
        }
        instruction_counter = position;
